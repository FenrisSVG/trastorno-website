<template>
    <div class="socials" v-if="icons !== []" v-scroll-reveal.reset="{delay:400,easing: 'cubic-bezier(0.5, 0, 0, 1)'}">
      <div class="socials-container" v-for="(icon,index) in icons" :key="index">
        <span><a href="http://google.com" target="_blank" rel="noopener noreferrer nofollow">
        <i :class="icon"></i></a></span>
      </div>
    </div>
</template>
