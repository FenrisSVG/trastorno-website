<template>
  <div class="home">
    ...
    <main class="main">
      ...
      >
        <Index title="Trastornos Mentales" class="slider__aside--secondary" />
        <section class="section">
          <Chapter part="Parte 01" />
          <article class="article">
            <div class="article-header">
              <Title title="Trastornos" subtitle="Mentales" />
              <h3 class="article-header__subtitle">
                ¿Que son los Trastornos <span>Mentales</span> ?
              </h3>
            </div>
            <div class="article-body" v-if="trastornos.length > 0">
              <p
                class="article-body__text"
                v-for="item in trastornos"
                :key="item.id"
              >
                {{ item.text }}
              </p>
          ...
          <div class="section-image atropos my-atropos">
            <div class="atropos-scale">
              <div class="atropos-rotate">
                <div class="atropos-inner">
                  <img
                    src="../assets/desktop/main.webp"
                    alt="idk what i suppose to put here"
      ...
      <aside class="aside" v-scroll-reveal.reset="{ delay: 400, opacity: 0.2 }">
        ...
        <section class="section section--secondary">
          <div class="section-chapter section-chapter--secondary">
            <h2
          ...
          <div class="navigation">
            <div class="navigation-primary" v-if="navigation !== []">
              <div
              ...
              >
                ...
                >
                <i
                  class="fas fa-long-arrow-alt-right navigation-container__icon"
                ></i>
              </div>
            </div>
            <div class="navigation-primary" v-if="navigation !== []">
              <div
                class="navigation-container"
                v-for="item in navigation.slice(4, 8)"
                :key="item.id"
              >
                <a
                  :href="item.href"
...
import KindOfTrastornos from "./KindOfTrastornos.vue";
import Test from "./TestInfo.vue";
